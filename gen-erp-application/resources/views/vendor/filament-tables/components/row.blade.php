...
@php
    ...
    $stripedClasses = 'bg-gray-50/30 dark:bg-[#21262d]/30';
@endphp
...
<tr
    ...
    {{
        $attributes->class([
            'fi-ta-row transition-colors duration-150',
            'hover:bg-gray-50/50 dark:hover:bg-[#21262d]/50 cursor-pointer' => $recordAction || $recordUrl,
