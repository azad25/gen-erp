    ...
    <div class="modern-auth-container">
        ...
        <div class="auth-form-side">
            <div class="auth-form-wrapper">
                ...
                <h1 class="auth-title">{{ __('filament-panels::pages/auth/register.heading') }}</h1>
        ...
        <div class="auth-illustration-side">
            ...
            <div class="illustration-content">
                ...
                <h2 class="illustration-title">{{ __('Start your journey today.') }}</h2>
                <p class="illustration-description">{{ __('Join thousands of businesses transforming their operations with GenERP. Get started in minutes with our easy setup process.') }}</p>
            </div>
        </div>
    </div>
</x-filament-panels::page.simple>
