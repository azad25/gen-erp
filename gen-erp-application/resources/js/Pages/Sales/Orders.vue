      ...
      <AdminLayout>
        <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-xl font-bold text-black">Sales Orders</h1>
              <p class="text-sm text-gray-1">Manage sales orders for your business</p>
            </div>
          ...
          >
            ...
            <template #actions="{ row }">
              ...
              <Button variant="ghost" size="sm" @click="convertToInvoice(row)" :disabled="row.status !== 'confirmed'">Convert</Button>
        ...
        <!-- Create/Edit Modal -->
        <Modal v-if="showModal" @close="closeModal" :title="isEditing ? 'Edit Sales Order' : 'New Sales Order'">
        ...
        <!-- View Modal -->
        <Modal v-if="showViewModal" @close="showViewModal = false" title="Sales Order Details" size="lg">
          <div v-if="selectedOrder" class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="font-semibold">{{ selectedOrder.customer?.name }}</p>
              </div>
              <div>
