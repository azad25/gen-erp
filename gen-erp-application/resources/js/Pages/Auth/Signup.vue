          ...
          <div>
            ...
            <form @submit.prevent="handleSubmit">
              <div class="space-y-5">
                ...
                <div class="flex items-center">
                  <label for="terms" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                    <div class="relative">
                      <input v-model="terms" type="checkbox" id="terms" class="sr-only" />
                      <div :class="terms ? 'border-primary bg-primary' : 'bg-transparent border-gray-300 dark:border-gray-700'" class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]">
                        <span :class="terms ? '' : 'opacity-0'">
                    ...
                    আমি আমাদের <a href="/terms" class="text-primary hover:text-teal-700 dark:text-teal-400">শর্তাবলী</a> এবং <a href="/privacy" class="text-primary hover:text-teal-700 dark:text-teal-400">গোপনীয়তা নীতি</a> সম্মত হন
                  </label>
                </div>
                <!-- Button -->
                <div>
                  <button type="submit" :disabled="loading" class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-primary shadow-sm hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed">
                    <span v-if="loading">রেজিস্টার হচ্ছে...</span>
                    <span v-else>রেজিস্টার করুন</span>
                  </button>
                </div>
            ...
            <div class="mt-5">
              <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                আপনার কাছে ইতিমধেই একাউন্ট আছে?
                <a href="/login" class="text-primary hover:text-teal-700 dark:text-teal-400">লগইন করুন</a>
              </p>
            </div>
          </div>
        </div>
