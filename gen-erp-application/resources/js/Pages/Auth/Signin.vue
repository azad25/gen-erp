          ...
          <div>
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                আপনার ইমেইল এবং পাসওয়ার্ড দিয় লগইন করুন!
              </p>
            </div>
            <form @submit.prevent="handleSubmit">
              <div class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                  <div>
                    <label for="keepLoggedIn" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                      <div class="relative">
                        ...
                        <div :class="keepLoggedIn ? 'border-primary bg-primary' : 'bg-transparent border-gray-300 dark:border-gray-700'" class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]">
                  ...
                  <a href="/forgot-password" class="text-sm text-primary hover:text-teal-700 dark:text-teal-400">পাসওয়ার্ড ভুলে গেছেন?</a>
                </div>
                <!-- Button -->
                <div>
            ...
            <div class="mt-5">
              <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                একাউন্ট নেই?
                <a href="/register" class="text-primary hover:text-teal-700 dark:text-teal-400">রেজিস্টার করুন</a>
              </p>
            </div>
          </div>
        </div>
