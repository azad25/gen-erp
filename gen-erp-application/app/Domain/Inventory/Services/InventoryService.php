...
use App\Domain\Inventory\Actions\CreateWarehouseAction;
use App\Domain\Inventory\Actions\DeleteWarehouseAction;
use App\Domain\Inventory\Actions\UpdateWarehouseAction;
...
class InventoryService implements InventoryServiceInterface
{
    ...
    {
        return $this->updateWarehouseAction->execute($warehouse, $data);
    }
    ...
    {
        // Try to find existing level first
        ...
        // Create new level
        $companyId = \App\Domain\Inventory\Models\Warehouse::withoutGlobalScopes()
            ->findOrFail($warehouseId)->company_id;
