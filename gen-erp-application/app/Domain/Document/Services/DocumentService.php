...
class DocumentService implements DocumentServiceInterface
{
     ...
     */
    public function getFolders(int $companyId, ?string $search = null, ?int $parentId = null, int $perPage = 15): \Illuminate\Contracts\Pagination\LengthAwarePaginator
    {
    ...
    {
        return DocumentFolder::where('company_id', $companyId)->findOrFail($id);
    }
